...
var favoriteBook = Book(title: "The Life and Times of Kevin Natera", author: "Kevin Natera", pages: 2, price: 0.1)

print("'\(favoriteBook.title)' is an absolutely horrendous \(favoriteBook.pages) page long shit show penned by \(favoriteBook.author). Obtain your copy by visiting your local Barnes and Noble trashcan, or by donating \(favoriteBook.price) cents to the poor bastard.")
/*:
