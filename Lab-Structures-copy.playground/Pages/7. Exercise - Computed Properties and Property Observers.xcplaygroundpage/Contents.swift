...
var rectangle1 = Rectangle(width: 80, height: 90)
...
struct Height {
    var heightInInches: Double {
        didSet {
            if heightInCentimeters != self.heightInInches/2.54 {
                 heightInCentimeters = self.heightInInches * 2.54
            }
        }
    }
    ...
    var heightInCentimeters: Double {
        didSet {
            if heightInInches != self.heightInCentimeters * 2.54 {
            heightInInches = self.heightInCentimeters/2.54
            }
        }
    }
...
var someHeight = Height(heightInCentimeters: 50)

print(someHeight)

someHeight.heightInCentimeters = 60

print(someHeight)

var aHeight = Height(heightInInches: 70)

print(aHeight)

aHeight.heightInInches = 80
