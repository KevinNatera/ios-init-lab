...
class Fighter : Spaceship {
    ...
    func fire() {
        if remainingFirePower > 0 {
            ...
            print("You have no remaining fire power.")
        }
    }
}
 ...
 */
//Print(falcon.weapon) doesn't work because 'weapon' is a property of the 'Fighter' subclass, which 'falcon' is not a member of, and as such, does not possess.
